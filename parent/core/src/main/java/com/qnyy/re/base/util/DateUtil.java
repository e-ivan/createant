...
public class DateUtil {
    ...
    public static final String WXPAY_DATE_FORMAT = "yyyyMMddHHmmss";
    /**
     * 得到一天的最后一秒钟
     *
     * @param d
...
//    }
     ...
     * @return
     */
    public static String wechatPayDateFormat(Date now,int minute){
        return DateFormatUtils.format(DateUtils.addMinutes(now, minute), "yyyyMMddHHmmss");
    }
    public static String wechatPayDateFormat(Date now){
        return wechatPayDateFormat(now,0);
    }
