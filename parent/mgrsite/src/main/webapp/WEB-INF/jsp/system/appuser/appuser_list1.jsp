        ...
        <div class="main-content-inner">
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- 检索  -->
                        <form action="happuser/listUsers1.do" method="post" name="userForm" id="userForm">
                                        ...
                                        <c:forEach items="${page.result}" var="user" varStatus="vs">
                                            <tr>
                                                <td class='center' style="width: 30px;">
                                                    <label><input type='checkbox' name='ids' value="${user.uid}"
                                                ...
                                                <td class="center">${user.promoCode}</td>
                                                <td class="center"><fmt:formatDate value="${user.updated}"
