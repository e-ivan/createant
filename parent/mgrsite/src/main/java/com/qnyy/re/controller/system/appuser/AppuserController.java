package com.qnyy.re.controller.system.appuser;
...
import com.qnyy.re.mgr.util.AppUtil;
import com.qnyy.re.mgr.util.Jurisdiction;
import com.qnyy.re.mgr.util.MD5;
import com.qnyy.re.mgr.util.ObjectExcelView;
...
public class AppuserController extends BaseController {
	...
	public String listUsers1(Model model, @ModelAttribute("qo") UserInfoQueryObject qo){
		model.addAttribute("page",userInfoService.queryUser(qo));
		model.addAttribute("QX", Jurisdiction.getHC());
		return "system/appuser/appuser_list1";
	}
